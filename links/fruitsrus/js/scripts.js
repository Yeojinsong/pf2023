...
Description:JavaScript external file for Fruits 'R' Us website
*/
...
function checkAddCustomer(regoForm){
	...
	//test that state has been selected	
	var selection = regoForm.stateId.selectedIndex; // get the selecton which has been checked by user in html form 
	
	if(regoForm.stateId.options[selection].value == ""){
		//add error message to errMsg variable
	...
	if(isNaN(regoForm.postCode.value)){
		...
		// test that number is 4 digits long
		if(regoForm.postCode.value.length != 4){
			//add error message to errMsg variable
			errMsg =errMsg + "invallid post code lenght\n";
		}
	}
...
function checkUpdateCustomer(updateForm){
	...
	if(isNaN(updateForm.postCode.value)){
		...
		// test that number is 4 digits long
		if(updateForm.postCode.value.length != 4){
			//add error message to errMsg variable
			errMsg =errMsg + "invallid post code lenght\n";
		}
	}
