...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["imgUpload"]["tmp_name"], $target_file)) {
		...
		try {
			$sql = "INSERT INTO tbl_clientStory (name, story, img, activeBeInformed, activeSeekHelp, activeGetInvolved) VALUES (:name, :story, :img, :activeBeInformed, :activeSeekHelp, :activeGetInvolved);";
			...
			echo "Error adding Client Story: " . $e->getMessage();
			exit();
		}
