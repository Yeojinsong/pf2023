<?php
// Slider Update
if (isset ($_POST['sliderUpdateSubmit'])) {
		...
		if (!$_FILES['imgUpload']['name']=='') {
			...
			// if everything is ok, try to upload file
			    ...
			    if (move_uploaded_file($_FILES["imgUpload"]["tmp_name"], $target_file)) {
			    	$sql = "UPDATE tbl_slider SET name = :name, img = :img, heading = :heading, body = :body, active = :active WHERE id = :id;";
			...
			$sql = "UPDATE tbl_slider SET name = :name, heading = :heading, body = :body, active = :active WHERE id = :id;";
			$statement = $pdo->prepare($sql);
		}
