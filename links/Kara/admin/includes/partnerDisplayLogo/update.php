<?php
// partner Update
if (isset ($_POST['partnerDisplayLogoUpdateSubmit'])) {
		...
		if (!$_FILES['imgUpload']['name']=='') {
			...
			// if everything is ok, try to upload file
			    ...
			    if (move_uploaded_file($_FILES["imgUpload"]["tmp_name"], $target_file)) {
			    	$sql = "UPDATE tbl_partner SET name = :name, logo = :logo, displayLogo = :displayLogo, url = :url, active = :active WHERE id = :id;";
			...
			$sql = "UPDATE tbl_partner SET name = :name, displayLogo = :displayLogo, url = :url, active = :active WHERE id = :id;";
			$statement = $pdo->prepare($sql);
		}
