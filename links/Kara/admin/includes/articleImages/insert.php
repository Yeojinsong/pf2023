...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["imgUpload"]["tmp_name"], $target_file)) {
		...
		$mediaId = cleanInput($_POST['mediaId']);

		try {
			$sql = "INSERT INTO tbl_mediaImage (name, img, mediaId, active) VALUES (:name, :img, :mediaId, :active);";
			...
			echo "Error adding article image : " . $e->getMessage();
			exit();
		}
