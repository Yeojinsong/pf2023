			...
			<div class="row">
				<div class="col-12">
					...
					<div class="accordionContent newSlider">
						<form action="includes/social-media/insert.php" method="POST" enctype="multipart/form-data">
							<fieldset>
								...
								<input class="formButton" name="social-Add-Submit" type="submit" value="Add"/>
							</fieldset>
						</form>
					</div>
				</div>
				...
				<div class="col-12">
					...
					<div class="accordionContentOpen updateSlider row">
						...
						try {
							...
							$sql = "SELECT id, name, img, url, active FROM tbl_socialMedia;";
						...
						foreach ($resultSet as $row) {
							...
							<article class="col-12 col-md-6">
								...
								<form action="includes/social-media/update.php" method="POST" enctype="multipart/form-data">
									...
									<input id="submit<?php echo $id; ?>" class="formSubmit formButton" name="social-media-update" type="submit" value="Submit"/>
									<input id="cancel<?php echo $id; ?>" class="formCancel cancelButton" type="button" onclick='disableForm(<?php echo $id; ?>)' value="Cancel"/>
								</form>

								<form action="includes/social-media/delete.php" id="deleteForm<?php echo $id; ?>" class="deleteForm" onsubmit="return checkDelete();" method="POST">
									<input type="hidden" name="id" value="<?php echo $id; ?>">
									<input type="submit" class="cancelButton" name="social-media-delete" value="Delete"/>
								</form>
								<hr><br>
							</article>
							<?php
